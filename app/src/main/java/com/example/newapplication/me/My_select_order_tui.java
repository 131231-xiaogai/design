...
public class My_select_order_tui extends AppCompatActivity implements View.OnClickListener {

    private TextView title_page;
    private ImageButton title_back,btn_notice;
    private String shop_id,status,my_find_name;
    private Order_tui_Adapter sk_orderAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sk_orderAdapter = new Order_tui_Adapter(this);
        ...
        sk_orderAdapter.setOnItemClickListener(new OnItemClickListener<OrderBean>() {
            ...
            public void onItemClick(RecyclerViewHolder viewHolder, OrderBean data, int position) {
                Toast.makeText(My_select_order_tui.this, data.getGoods_id(), Toast.LENGTH_SHORT).show();
            }
        });
        //-------------------**----------------------------//
    ...
    private void loadData() {
        String userID = SharePrefrenceUtil.getObject(My_select_order_tui.this, UsersBean.class).getUerid();
        Map map = new HashMap();
        ...
        OkHttp.get(this, Constant.select_order_byUseridAndOrderStstus_likeName, map, new OkCallback<Result<List<OrderBean>>>() {
            ...
            public void onFailure(String state, String msg) {
                Toast.makeText(My_select_order_tui.this, msg, Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.my_select_order_back:
                My_select_order_tui.this.finish();
                break;
            case R.id.my_select_order_notice:
                startActivity(new Intent(My_select_order_tui.this, Notice.class));
                break;
