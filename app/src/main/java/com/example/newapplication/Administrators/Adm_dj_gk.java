...
public class Adm_dj_gk extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        select_userAdapter.setOnItemClickListener(new OnItemClickListener<UsersBean>() {
            ...
            public void onItemClick(RecyclerViewHolder viewHolder, UsersBean data, int position) {
                ...
                dialog = new AlertDialog.Builder(Adm_dj_gk.this);
                dialog.setTitle("提示");
                ...
                dialog.setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        OkHttp.get(Adm_dj_gk.this, Constant.update_user_role, map, new OkCallback<Result<String>>() {
                            @Override
                            public void onResponse(Result<String> response) {
                                Toast.makeText(Adm_dj_gk.this, "已经冻结该用户。", Toast.LENGTH_SHORT).show();
                                loadData();
                            }
                            @Override
                            public void onFailure(String state, String msg) {
                                Toast.makeText(Adm_dj_gk.this, msg, Toast.LENGTH_SHORT).show();
                            }
                        });
                    }
                });
