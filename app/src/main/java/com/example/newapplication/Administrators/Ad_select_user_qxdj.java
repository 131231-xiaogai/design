...
public class Ad_select_user_qxdj extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        sk_orderAdapter.setOnItemClickListener(new OnItemClickListener<UsersBean>() {
            ...
            public void onItemClick(RecyclerViewHolder viewHolder, UsersBean data, int position) {
                Toast.makeText(Ad_select_user_qxdj.this, data.getUerid(), Toast.LENGTH_SHORT).show();
                user_id=data.getUerid();
                AlertDialog.Builder dialog;
                dialog = new AlertDialog.Builder(Ad_select_user_qxdj.this);
                dialog.setTitle("提示");
                ...
                dialog.setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        OkHttp.get(Ad_select_user_qxdj.this, Constant.update_user_role, map, new OkCallback<Result<String>>() {
                            @Override
                            public void onResponse(Result<String> response) {
                                Toast.makeText(Ad_select_user_qxdj.this, "已经取消冻结该用户。", Toast.LENGTH_SHORT).show();
                                Intent intent = new Intent();
                                intent.putExtra("data_return","已经取消冻结该用户");
                                setResult(RESULT_OK,intent);
                                Ad_select_user_qxdj.this.finish();
                            }
                            @Override
                            public void onFailure(String state, String msg) {
                                Toast.makeText(Ad_select_user_qxdj.this, msg, Toast.LENGTH_SHORT).show();
                            }
                        });
                    }
                });
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.ad_select_user_notice:
                startActivity(new Intent(Ad_select_user_qxdj.this, Notice.class));
                break;
