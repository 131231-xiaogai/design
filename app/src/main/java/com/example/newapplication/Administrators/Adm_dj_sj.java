...
public class Adm_dj_sj extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        select_userAdapter.setOnItemClickListener(new OnItemClickListener<UsersBean>() {
            ...
            public void onItemClick(RecyclerViewHolder viewHolder, UsersBean data, int position) {
                ...
                dialog = new AlertDialog.Builder(Adm_dj_sj.this);
                dialog.setTitle("提示");
                ...
                dialog.setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        OkHttp.get(Adm_dj_sj.this, Constant.update_user_role, map, new OkCallback<Result<String>>() {
                            @Override
                            public void onResponse(Result<String> response) {
                                Toast.makeText(Adm_dj_sj.this, "已经冻结该用户。", Toast.LENGTH_SHORT).show();
                                loadData();
                            }
                            @Override
                            public void onFailure(String state, String msg) {
                                Toast.makeText(Adm_dj_sj.this, msg, Toast.LENGTH_SHORT).show();
                            }
                        });
                    }
                });
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.adm_title_back:
                Adm_dj_sj.this.finish();
                break;
            case R.id.ad_select_user:
                Intent intent1 = new Intent(Adm_dj_sj.this, Ad_select_shop_dj.class);
