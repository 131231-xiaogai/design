...
public class Sk_select_order_huan extends AppCompatActivity implements View.OnClickListener {

    private TextView title_page;
    private ImageButton title_back,btn_notice;
    private String shop_id,status,my_find_name;
    private Sk_Order_huanAdapter sk_orderAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sk_orderAdapter = new Sk_Order_huanAdapter(this);
        ...
        sk_orderAdapter.setOnItemClickListener(new OnItemClickListener<OrderBean>() {
            ...
            public void onItemClick(RecyclerViewHolder viewHolder, OrderBean data, int position) {
                Toast.makeText(Sk_select_order_huan.this, data.getGoods_id(), Toast.LENGTH_SHORT).show();
            }
        });
        //-------------------**----------------------------//
    ...
    private void loadData() {
        ...
        OkHttp.get(this, Constant.select_order_byShopidAndOrderStstus_likeName, map, new OkCallback<Result<List<OrderBean>>>() {
            ...
            public void onFailure(String state, String msg) {
                Toast.makeText(Sk_select_order_huan.this, msg, Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.sk_select_order_back:
                Sk_select_order_huan.this.finish();
                break;
            case R.id.sk_select_order_notice:
                Intent intent5 = new Intent(Sk_select_order_huan.this, Sk_Notice.class);
